...
#include <stdlib.h> //this library wasn't included before
...
void run_game(int computer_number); //there was nothing here before
...
{
    int number = 0;
	int correct = 0; //correct was not initialized before
