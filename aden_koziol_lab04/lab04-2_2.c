...
void how_many_whole_digits(int number)
{
	...
	if ((double) number / 10000000 >= 1) 
    {
        printf("8 digits\n");
    } 
	//else if ((double) number / 1000000 != 0)
	else if ((double) number / 1000000 >= 1) 
    {
        printf("7 digits\n");
    } 
	//else if ((double) number / 100000 != 0)
	else if ((double) number / 100000 >= 1) 
    {
        printf("6 digits\n");
    } 
	//else if ((double) number / 10000 != 0)
	else if ((double) number / 10000 >= 1)	
    {
        printf("5 digits\n");
    } 
	//else if ((double) number / 1000 != 0)
	else if ((double) number / 1000 >= 1)	
    {
        printf("4 digits\n");
    }
	//else if ((double) number / 100 != 0)
	else if ((double) number / 100 >= 1)	
    {
        printf("3 digits\n");
    } 
	//else if ((double) number / 10 != 0)
	else if ((double) number / 10 >= 1) 
    {
        printf("2 digits\n");
    } 
	//else if ((double) number / 1 != 0)
	else if ((double) number / 1 >= 1) 
    {
        printf("1 digit\n");
    }
}
